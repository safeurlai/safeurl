 ...
 * Note: In practice, credits are added via Stripe webhook after payment confirmation.
 * This endpoint can be used for direct credit additions (e.g., from webhook handler or admin).
 */
...
> {
  ...
  if (request.paymentMethod === "stripe") {
    ...
    const stripeSessionId = request.paymentDetails?.stripeSessionId as
      | string
      | undefined;
