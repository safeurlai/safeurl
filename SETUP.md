...
# LLM Provider (OpenRouter - Required for Mastra agent)
# Get your API key from https://openrouter.ai/keys
OPENROUTER_API_KEY=sk-or-v1-...
# Note: The worker service requires OPENROUTER_API_KEY to be set
# for the fetcher containers to execute Mastra agent analysis
